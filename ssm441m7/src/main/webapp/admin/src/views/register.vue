  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jiazhengrenyuan'" class="input-group">
			   <div class="label">家政姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiazhengxingming" class="input" type="text" placeholder="家政姓名">
			   </div>
			 </div> -->
			<el-form-item label="家政姓名" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.jiazhengxingming" autocomplete="off" placeholder="家政姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhengrenyuan'" class="input-group">
			   <div class="label">家政账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiazhengzhanghao" class="input" type="text" placeholder="家政账号">
			   </div>
			 </div> -->
			<el-form-item label="家政账号" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.jiazhengzhanghao" autocomplete="off" placeholder="家政账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhengrenyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.lianxifangshi" autocomplete="off" placeholder="联系方式"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhengrenyuan'" class="input-group">
			   <div class="label">最高学历</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zuigaoxueli" class="input" type="text" placeholder="最高学历">
			   </div>
			 </div> -->
			<el-form-item label="最高学历" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.zuigaoxueli" autocomplete="off" placeholder="最高学历"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhengrenyuan'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhengrenyuan'" class="input-group">
			   <div class="label">服务金额</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fuwujine" class="input" type="text" placeholder="服务金额">
			   </div>
			 </div> -->
			<el-form-item label="服务金额" class="input" v-if="tableName=='jiazhengrenyuan'">
			  <el-input v-model="ruleForm.fuwujine" autocomplete="off" placeholder="服务金额"  />
			</el-form-item>
