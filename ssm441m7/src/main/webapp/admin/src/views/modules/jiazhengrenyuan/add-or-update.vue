<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家政账号" prop="jiazhengzhanghao">
          <el-input v-model="ruleForm.jiazhengzhanghao" 
              placeholder="家政账号" clearable  :readonly="ro.jiazhengzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="家政账号" prop="jiazhengzhanghao">
              <el-input v-model="ruleForm.jiazhengzhanghao" 
                placeholder="家政账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="家政类型" prop="jiazhengleixing">
          <el-select :disabled="ro.jiazhengleixing" v-model="ruleForm.jiazhengleixing" placeholder="请选择家政类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="家政类型" prop="jiazhengleixing">
	      <el-input v-model="ruleForm.jiazhengleixing"
                placeholder="家政类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="最高学历" prop="zuigaoxueli">
          <el-input v-model="ruleForm.zuigaoxueli" 
              placeholder="最高学历" clearable  :readonly="ro.zuigaoxueli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="最高学历" prop="zuigaoxueli">
              <el-input v-model="ruleForm.zuigaoxueli" 
                placeholder="最高学历" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务金额" prop="fuwujine">
          <el-input v-model="ruleForm.fuwujine" 
              placeholder="服务金额" clearable  :readonly="ro.fuwujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务金额" prop="fuwujine">
              <el-input v-model="ruleForm.fuwujine" 
                placeholder="服务金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="特长" prop="tezhang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="特长"
                  v-model="ruleForm.tezhang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tezhang" label="特长" prop="tezhang">
                    <span>{{ruleForm.tezhang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="工作经验" prop="gongzuojingyan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gongzuojingyan" label="工作经验" prop="gongzuojingyan">
                    <span v-html="ruleForm.gongzuojingyan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gongzuojingyan = this.ruleForm.gongzuojingyan.replace(reg,'../../../ssm441m7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
