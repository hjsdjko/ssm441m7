<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家政类型" prop="jiazhengleixing">
          <el-input v-model="ruleForm.jiazhengleixing" 
              placeholder="家政类型" clearable  :readonly="ro.jiazhengleixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工资地址" prop="gongzidizhi">
          <el-input v-model="ruleForm.gongzidizhi" 
              placeholder="工资地址" clearable  :readonly="ro.gongzidizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工资地址" prop="gongzidizhi">
              <el-input v-model="ruleForm.gongzidizhi" 
                placeholder="工资地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="工资需求" prop="gongzixuqiu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gongzixuqiu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongzixuqiu" label="工资需求" prop="gongzixuqiu">
                    <span v-html="ruleForm.gongzixuqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gongzixuqiu = this.ruleForm.gongzixuqiu.replace(reg,'../../../ssm441m7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
